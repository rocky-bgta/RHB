...
public class DcpAccountDataTest {
    ...
    public void findByValueNotFound() {
        ...
        BDDMockito.given(boSearchRepository.searchUserProfileByAccountInfoValue("910203065250")).willReturn(userProfile);

        this.uut.findByValue("muhammad.ali",1);

        BDDMockito.verify(boSearchRepository, Mockito.atLeastOnce()).searchUserProfileByAccountInfoValue("910203065250");
    }
    ...
    public void findByValueFoundCustomer() {
        ...
        BDDMockito.given(boSearchRepository.searchUserProfileByAccountInfoValue("910203065250")).willReturn(userProfiles);

        SearchedCustomerResponse actualResult = (SearchedCustomerResponse) this.uut.findByValue("910203065250",1);
