...
public class DuitnowAdditionalDataRetriever implements AuditAdditionalDataRetriever {

    private AdditionalDataHolder additionalDataHolder;

    public DuitnowAdditionalDataRetriever(AdditionalDataHolder additionalDataHolder) {
