...
public class PutUnblockFacilityAdditionalDataRetriever implements AuditAdditionalDataRetriever {
	
	private AdditionalDataHolder additionalDataHolder;

    public PutUnblockFacilityAdditionalDataRetriever(AdditionalDataHolder additionalDataHolder) {
