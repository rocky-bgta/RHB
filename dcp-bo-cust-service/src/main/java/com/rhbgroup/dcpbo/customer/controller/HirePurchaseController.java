...
public class HirePurchaseController {
	@Autowired
	private HirePurchaseDetailsService hirePurchaseDetailsService;

	private static Logger logger = LogManager.getLogger(HirePurchaseController.class);

	@BoControllerAudit(eventCode = "30020")
	@GetMapping(value = "/cs/customer/loan/hp/{accountNo}/details", produces = {MediaType.APPLICATION_JSON_UTF8_VALUE})
	public BoData getHirePurchaseDetails(
		...
		return hirePurchaseDetailsService.getHirePurchaseDetails(customerId, accountNo);
	}
}
