...
public class DcpAccountData implements DcpData {
    ...
    public  BoData findByValue(String value, Integer pageNo) {
        ...
        List<UserProfile> userProfile = this.boSearchRepository.searchUserProfileByAccountInfoValue(value);
        isSearchNotFound(userProfile);
        ...
        for(UserProfile singleProfile: userProfile){
            ...
            //searchedCustomer.setAaoip(userProfile.get);   //not map within UserProfile entity
    ...
    private void isSearchNotFound(List<UserProfile> userProfile) {
