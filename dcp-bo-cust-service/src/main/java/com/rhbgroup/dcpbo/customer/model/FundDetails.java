...
public class FundDetails {
    ...
    @Column(name = "SUSPENSION_FROM_DATETIME", nullable = true)
    Timestamp suspensionFromDateTime;

    @Column(name = "SUSPENSION_TO_DATETIME", nullable = true)
    ...
    @Column(name = "BANK_CHARGE_AMOUNT",nullable = true, columnDefinition="Decimal(17,2)" )
    private BigDecimal bankChargeAmount;
    
    @Column(name = "BANK_CHARGE_PERCENTAGE",nullable = true, columnDefinition="Decimal(17,2)" )
