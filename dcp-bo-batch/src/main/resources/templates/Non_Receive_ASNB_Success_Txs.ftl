				...
				<table bgcolor="#ffffff" class="content" align="center"
					...
					<tr>
						...
						<td class="innerpadding borderbottom">
							...
							<table>
								<tr>
									<td class="innerpadding bodycopy">Hi Ops & Settlement
										team,</td>
								</tr>
								<tr>
									<td></td>
								...
								<tr>
									<td class="innerpadding bodycopy">Please be informed that
										no Successful Transaction listing file being received from
										ASNB today ${time}.</td>
								</tr>
								<tr>
									<td></td>
								...
								<tr>
									<td class="innerpadding bodycopy">However, there is
										successful transaction at bank side as per below:</td>
								</tr>
								<tr>
									<td></td>
								</tr>
					...
					<tr>
						<td class="innerpadding borderbottom">
							...
							<table class="col380" align="center" border="1" cellpadding="0"
								cellspacing="0" style="width: 100%; max-width: 380px;">
