...
@Component
@Lazy
public class BillerPaymentInjectReportIdTasklet  implements Tasklet, InitializingBean{
    static final Logger logger = Logger.getLogger(BillerPaymentInjectReportIdTasklet.class);
