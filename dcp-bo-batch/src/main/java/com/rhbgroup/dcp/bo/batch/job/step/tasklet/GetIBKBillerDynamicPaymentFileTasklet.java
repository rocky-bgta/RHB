...
import com.rhbgroup.dcp.bo.batch.job.model.BillerPaymentInboundTxn;
import com.rhbgroup.dcp.bo.batch.job.repository.BatchBillerDynamicPaymentConfigRepositoryImpl;

@Component
@Lazy
public class GetIBKBillerDynamicPaymentFileTasklet implements Tasklet {

	private static final Logger logger = Logger.getLogger(GetIBKBillerDynamicPaymentFileTasklet.class);
