...
@Lazy
@Scope("prototype")
public class BillerDynamicPaymentFileOutboundFtpTasklet implements Tasklet, InitializingBean  {
    static final Logger logger = Logger.getLogger(BillerDynamicPaymentFileOutboundFtpTasklet.class);
