...
import com.rhbgroup.dcp.bo.batch.framework.repository.FinancialTransactionRepositoryImpl;
import com.rhbgroup.dcp.bo.batch.framework.utils.BatchUtils;

@Component
@Lazy
public class SummaryFinancialTransactionTasklet implements Tasklet, InitializingBean {

    private static final Logger logger = Logger.getLogger(SummaryFinancialTransactionTasklet.class);

    @Autowired
    private FinancialTransactionRepositoryImpl financialTransactionRepositoryImpl;
    ...
    public RepeatStatus execute(StepContribution stepContribution, ChunkContext chunkContext) throws Exception {
        ...
        try {
            ...
            logger.info(message);
            if (parameterKey.equals("FINANCIAL_TRANSACTIONS") && financialTransactionRepositoryImpl.totalRec() < 2) {
                financialTransactionRepositoryImpl.insertSummary();
            }
