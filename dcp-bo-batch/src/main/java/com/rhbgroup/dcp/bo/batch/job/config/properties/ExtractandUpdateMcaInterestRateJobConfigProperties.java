...
@Lazy
@ConfigurationProperties("job.extractandupdatemcainterestratejob")
@Getter
@Setter
public class ExtractandUpdateMcaInterestRateJobConfigProperties extends BaseRestAPIConfigProperties implements BaseJobConfigProperties {
