...
@Configuration
@Lazy
public class RunReportWithDateRangeJobConfiguration extends BaseRunReportJobConfiguration {

	private static final String JOB_NAME = "RunReportWithDateRangeJob";
