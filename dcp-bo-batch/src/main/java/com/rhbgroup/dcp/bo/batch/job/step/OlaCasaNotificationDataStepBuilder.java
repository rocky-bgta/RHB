...
@Component
@Lazy
public class OlaCasaNotificationDataStepBuilder extends BaseStepBuilder {
    @Autowired
    private OlaCasaNotificationDataTasklet olaCasaNotificationDataTasklet;

    @Override
    public Step buildStep() {
        return getDefaultStepBuilder("OlaCasaNotificationDataStep")
                .tasklet(this.olaCasaNotificationDataTasklet)
                .build();
    }
}
