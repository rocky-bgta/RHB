...
@Component
@Qualifier("ExtractAndUpdateExchangeRateJobConfigProperties")
@Lazy
@ConfigurationProperties("job.extractandupdateexchangeratejob")
@Getter
@Setter
public class ExtractAndUpdateExchangeRateJobConfigProperties extends BaseRestAPIConfigProperties implements BaseJobConfigProperties {
