...
import com.rhbgroup.dcp.bo.batch.job.config.ExtractCustomerProfileJobConfiguration;
import com.rhbgroup.dcp.bo.batch.test.common.BaseFTPJobTest;
import com.rhbgroup.dcp.bo.batch.test.config.BatchTestConfigHSQL;

@RunWith(SpringRunner.class)
@SpringBootTest(classes= {BatchTestConfigHSQL.class, ExtractCustomerProfileJobConfiguration.class})
@ActiveProfiles("test")
public class ExtractCustomerProfileJobTests extends BaseFTPJobTest {

    private static final Logger logger = Logger.getLogger(ExtractCustomerProfileJobTests.class);
    public static final String JOB_NAME = "ExtractCustomerProfileJob";
    public static final String JOB_LAUNCHER_UTILS = "ExtractCustomerProfileJobLauncherTestUtils";
