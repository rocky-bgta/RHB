...
@ActiveProfiles("test")
public class LoadMassNotificationsFileToStagingWithoutParameterDateStepTest extends BaseJobTest {
	...
	public StepExecution getStepExecution() {
		...
		executionContextMap.put(BatchJobParameter.BATCH_JOB_PARAMETER_DB_BATCH_SYSTEM_DATE_KEY, DateUtils.formatDate(PARAMETER_DATE, General.DEFAULT_DATE_FORMAT));
