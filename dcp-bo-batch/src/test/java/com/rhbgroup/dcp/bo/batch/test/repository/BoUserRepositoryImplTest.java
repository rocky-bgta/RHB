...
@ActiveProfiles("test")
public class BoUserRepositoryImplTest extends BaseJobTest {

	private static final String TIME_FORMAT = "yyyy-MM-dd HH:mm:ss";
	
	@Autowired
	private BoUserRepositoryImpl repository;
	...
	@Test
	public void testPositiveUpdateUserStatus() throws ParseException, BatchException {
		...
		repository.updateUserStatus(batchUserMaintAutoAging, updatedBy);
	}
	
	@Test
	public void testNegativeUpdateUserStatus() throws ParseException, BatchException {
		long jobExecutionId = 0L;
		int userId = 4;
		String updatedBy = "TESTER";
