...
import com.rhbgroup.dcp.bo.batch.job.config.RunReportJobConfiguration;
import com.rhbgroup.dcp.bo.batch.test.common.BaseFTPJobTest;
import com.rhbgroup.dcp.bo.batch.test.config.BatchTestConfigHSQL;

@RunWith(SpringRunner.class)
@SpringBootTest(classes = {BatchTestConfigHSQL.class, RunReportJobConfiguration.class})
@ActiveProfiles("test")
public class RunReportJobTests extends BaseFTPJobTest {
    ...
    public void testJob() throws Exception {
        ...
        JobParameters jobParameters = new JobParametersBuilder()
        			...
        			.addString("reportid", "DMBUD003")
                    .addString("offsetday", "0")
    ...
    @Test
    public void testExternalBatchConfigReportSuccess() throws Exception {

    	// Replace .addDate("now",new Date())
        JobParameters jobParameters = new JobParametersBuilder()
        			.addString("date", "2018-08-14")
        			.addString("jobname", JOB_NAME)
        			.addString("reportid", "DMBBT001")
                    .toJobParameters();
        JobExecution jobExecution = jobLauncherTestUtils.launchJob(jobParameters);
        Assert.assertEquals("COMPLETED", jobExecution.getExitStatus().getExitCode());
...
*/
        ...
        FTPUtils.createFTPFolderIfNotExists(generateFolderPath(workingDir, "target", "DMB_TXNVOL"), defaultFTPConfigProperties);
    }
