...
@SpringBootTest(classes = { InfoServiceControllerTest.class, InfoController.class })
@EnableWebMvc
public class InfoServiceControllerTest {
	...
	private static Logger logger = LogManager.getLogger(InfoServiceControllerTest.class);
